...
public class RangerSystemAccessControl
    ...
    private boolean checkPermission(RangerPrestoResource resource, Identity identity, PrestoAccessType accessType) {
        ...
        System.out.println("Checking which plugin to use : " + resource.getCatalog() + " : " + resource.getSchema() + ": " + resource.getTable() + " : " + rangerHivePlugin);
        ...
        if ("hive".trim().equalsIgnoreCase(resource.getCatalog()) && (
            ...
            System.out.println("Using Hive Autz Plugin : " + hiveAccessRequest);
            result = rangerHivePlugin.isAccessAllowed(hiveAccessRequest);
        } else {
            System.out.println("Using Presto Autz Plugin : " + request);
